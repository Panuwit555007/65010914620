...
<head>
<meta charset="utf-8">
<title>สมัครสมาชิกชมรมสัตว์โบราณ ภาณุวิชญ์ ฉายเรือง(พี)</title>
</head>

<body>
<img src="6.png">
<h1>สมัครสมาชิกชมรมสัตว์โบราณ ภาณุวิชญ์ ฉายเรือง(พี)</h1>
<form method="post" action="">
    ...
    อาชีพ
        <select name="province">
            ...
            <option value="สฟิงก์">สฟิงก์</option>
            <option value="อื่นๆ">อื่นๆ</option>
        </select> <br>
        หมวดหมู่สัตว์โบราณที่ชื่นชอบ 
...
if(isset($_POST['Submit'])){
    ...
    echo "หมวดหมู่สัตว์โบราณที่ชื่นชอบ: ";
    if(isset($_POST['b'])){
